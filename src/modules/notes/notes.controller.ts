...
import { NoteBody, NoteQuery, NoteParams, NoteResponse, NoteListResponse, FullNoteResponse } from "./notes.dto";
...
class NotesController extends BaseController {
	...
	@Put("/:id", { params: NoteParams, body: NoteBody, response: FullNoteResponse })
